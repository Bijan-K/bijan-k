...
[![My Skills](https://skillicons.dev/icons?i=git,html,css,bootstrap,tailwind,sass,javascript,ts,react,nextjs,svelte,nodejs,express,python,pytorch,linux,bash&perline=13)](https://skillicons.dev)
